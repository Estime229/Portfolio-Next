  ...
  return (
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      <div className="h-max xl:px-12 lg:h-[22rem] p-6 sm:p-8 md:px-10 pt-32 md:pt-40 lg:pt-10 bg-gradient-to-tr dark:from-[#df51ad3e] dark:to-[#eb587d2a] from-[#f6ebeb90] to-[#fff8ec60] flex flex-col lg:flex-row mx-auto rounded-3xl shadow-md drop-shadow-2xl backdrop-blur-xl items-center justify-center lg:justify-between ">
        ...
        <div className=" order-1 lg:order-2 absolute -rotate-[15deg] lg:rotate-0 lg:flex top-6 right-4 md:top-10 md:right-12 lg:basis-[40%] mt-20 text-center">
          <div className="bg-purple-400  h-35 w-48 flex-col justify-end mx-auto blur-none z-40 items-center text-center text-xl text-white font-medium rounded-lg p-2 justify-center">
            <div className="basis-[60%] text-5xl font-black ">
              <h2 className="text-border mt-1  text-center">
                {diffYears}
                <sup className="text-lg">{`.${diffMonths + 1}`}</sup>
              </h2>
            </div>
            <div className="basis-[30%] text-xs mt-3 font-out text-center">
              Years of Experience
            </div>
          </div>
        </div>
      ...
      <div className="h-max xl:px-12 lg:h-[22rem] p-6 sm:p-8 md:px-10 pt-32 md:pt-40 lg:pt-10 bg-gradient-to-tr dark:from-[#df51ad3e] dark:to-[#eb587d2a] from-[#f6ebeb90] to-[#fff8ec60] flex flex-col lg:flex-row mx-auto rounded-3xl shadow-md drop-shadow-2xl backdrop-blur-xl items-center justify-center lg:justify-between ">
        ...
        <div className=" order-1 lg:order-2 absolute -rotate-[15deg] lg:rotate-0 lg:flex top-6 right-4 md:top-10 md:right-12 lg:basis-[40%] mt-20 text-center">
          <div className="bg-yellow-400  h-35 w-48 flex-col justify-end mx-auto blur-none z-40 items-center text-center text-xl text-white font-medium rounded-lg p-2 justify-center">
            <div className="basis-[60%] text-5xl font-black ">
              <h1 className="text-border mt-1  text-center">

                <sup className="text-lg">4 </sup>
              </h1>
            </div>
            <div className="basis-[30%] text-xs mt-3 font-out text-center">
              Years of Experience
      ...
      <div className="h-max xl:px-12 lg:h-[22rem] p-6 sm:p-8 md:px-10 pt-32 md:pt-40 lg:pt-10 bg-gradient-to-tr dark:from-[#df51ad3e] dark:to-[#eb587d2a] from-[#f6ebeb90] to-[#fff8ec60] flex flex-col lg:flex-row mx-auto rounded-3xl shadow-md drop-shadow-2xl backdrop-blur-xl items-center justify-center lg:justify-between ">
        ...
        <div className=" order-1 lg:order-2 absolute -rotate-[15deg] lg:rotate-0 lg:flex top-6 right-4 md:top-10 md:right-12 lg:basis-[40%] mt-20 text-center">
          <div className="bg-green-400  h-35 w-48 flex-col justify-end mx-auto blur-none z-40 items-center text-center text-xl text-white font-medium rounded-lg p-2 justify-center">
            <div className="basis-[60%] text-5xl font-black ">
              <h1 className="text-border mt-1  text-center">
